 ...
 *
 * @method initializeTransformer
 * @async
 * @param {Object} transformer transformer to initialize
 * @param {Function} done callback
 */
var initializeTransformer = function (transformer, done) {
    parallel([
 ...
 * @param {Function} done callback
 */
var initializeTransformers = function (done) {
    eachParallel.call(this, this.transformers, function (transformer, key, done) {
        initializeTransformer.call(this, transformer[key], done);
    }, done);
};
 ...
 * @param {Function} done callback
 */
var runTransformers = function (done) {
    eachSerial.call(this, this.transformers, function (transformer, key, done) {
        runTransformer.call(this, transformer[key], done);
    }, done);
};
...
module.exports = {
    initializeTransformer: initializeTransformer,
    initializeTransformers: initializeTransformers,
