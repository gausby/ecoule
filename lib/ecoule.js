 ...
 * @param {Function} done callback
 */
Ecoule.prototype.initializeTransformer = function (transformer, done) {
    parallel([
...
Ecoule.prototype.initializeTransformers = function (done) {
    eachParallel.call(this, this.transformers, function (transformer, key, done) {
        this.initializeTransformer(transformer[key], done);
    }, done);
};
 ...
 * @param {Function} done callback
 */
Ecoule.prototype.refreshSource = function (source, done) {
        ...
        function (done) {
            eachSerial.call(this,
                ...
                function(sources, key, done) {
                    this.refreshSource(sources[key], done);
                },
                done
            );
        },
    ...
    parallel.call(this, [
        function(done) {
            return eachSerial.call(this, sources, function (sources, key, done) {
                var source = this.sources[sources[key]].data;
 ...
 * @param {Function} done callback
 */
Ecoule.prototype.runTransformer = function (transformer, done) {
    serial.call(this, [
...
Ecoule.prototype.runTransformers = function (done) {
    eachSerial.call(this, this.transformers, function (transformer, key, done) {
        this.runTransformer(transformer[key], done);
    }, done);
};
